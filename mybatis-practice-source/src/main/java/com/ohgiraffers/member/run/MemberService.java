...
public class MemberService {
    ...
    public MemberDTO selectMemberByCode(int number) {
        SqlSession sqlSession=getSqlSession();
        MemberMapper memberMapper=sqlSession.getMapper(MemberMapper.class);
        MemberDTO member=memberMapper.selectMemberByCode(number);
        sqlSession.close();
        return member;
    }
    ...
    public boolean deleteMember(int number) {
        SqlSession sqlSession=getSqlSession();
        MemberMapper memberMapper=sqlSession.getMapper(MemberMapper.class);
        int result=memberMapper.deleteMember(number);
