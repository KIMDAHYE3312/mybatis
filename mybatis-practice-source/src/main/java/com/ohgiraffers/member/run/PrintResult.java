...
public class PrintResult {
    public void printMenuList(List<MemberDTO> memberList) {
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch(errorCode) {
            ...
            case "insert" : errorMessage = "신규 회원 등록을 실패하였습니다."; break;
            case "update" : errorMessage = "회원 수정을 실패하였습니다."; break;
            case "delete" : errorMessage = "회원 삭제를 실패하였습니다."; break;
    }
...
public void printSuccessMessage(String successCode) {
    ...
    switch(successCode) {
        case "insert" : successMessage = "신규 회원 등록을 성공하였습니다."; break;
